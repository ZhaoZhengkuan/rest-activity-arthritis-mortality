#!/usr/bin/env python3
"""
Python PSU-within-strata bootstrap for the T1 RAR mediation and Cox sensitivity
analyses.
...
Percentile intervals are written as supplemental output. The default is 100
replicates. This bootstrap does not convert the model-based weighted analyses
into full design-based complex-survey regression.
"""

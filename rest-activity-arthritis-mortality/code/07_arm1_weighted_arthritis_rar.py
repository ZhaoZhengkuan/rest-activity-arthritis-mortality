#!/usr/bin/env python3
"""
Arm 1: cross-sectional weighted association of arthritis with
...
Inference:
    Weighted least squares with PSU-clustered robust standard errors. SDMVSTRA
    is not included in the model-based variance estimator; this is not full
    design-based complex-survey linear regression.
"""

#!/usr/bin/env python3
"""
MEC-weighted fixed-horizon g-formula for the secondary decomposition analysis.

Purpose
-------
This script implements the Python analysis reported in the manuscript. It does
not claim an R/CMAverse or full complex-survey confirmation. It provides an
auditable weighted g-formula calculation that:
...
The reported results come from this fixed-horizon Python implementation. The
R/CMAverse file in the repository is an unexecuted compatibility template.
"""
...
def main() -> int:
    ...
    manifest = {
        ...
        "note": "MEC-weighted Python fixed-horizon risk-difference g-formula used for the reported secondary analysis; no R/CMAverse or full complex-survey confirmation is claimed.",
    }
    ...
    report = [
        ...
        "",
        "Interpretation boundary: this secondary Python analysis uses a fixed-horizon risk-difference scale and 100 PSU-within-stratum bootstrap replicates; it is not an R/CMAverse or full complex-survey confirmation.",
    ]

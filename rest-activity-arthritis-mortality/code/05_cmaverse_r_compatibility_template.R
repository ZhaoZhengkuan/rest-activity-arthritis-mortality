...
#
# This script is intentionally not executed in the current machine because
# Rscript is not installed. It is included so the same folder can be moved to an
# R environment and used to confirm the preferred interventional survival
# mediation analysis.

...
These are case-weighted Cox models using lifelines with robust variance
clustered by SDMVPSU. They do not incorporate SDMVSTRA in the model-based
variance estimator and are not full design-based complex-survey Cox models.
"""
...
def main() -> int:
    ...
    report = [
        ...
        "",
        "This file records the Python case-weighted Cox sensitivity analyses reported in the manuscript, using SDMVPSU-clustered robust variance. No full complex-survey Cox confirmation is claimed.",
        "",
        "Key positioning:",
        "",
